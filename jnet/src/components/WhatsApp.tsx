...
export default function WhatsApp() {
  ...
  return (
    <div className="button-wrapper fixed right-5 bottom-5 z-5">
      <a className="whatsapp flex flex-row items-center" href={`https://api.whatsapp.com/send/?phone=5581984325732&text=Ol%C3%A1%2C+${horário}%2C+gostaria+de+saber+sobre+os+planos+disponíveis.%0APoderia+me+ajudar%3F&type=phone_number&app_absent=0`} target="_blank" rel="noreferrer">
