...
export default function Card({ children, label="-", title="MEGA", desc="-", listItems, valor="00,00", img, others_style={"--border-card-color": "#005dfe", "--button-fade-1": "#000082", "--button-fade-2": "#005dfe"} as React.CSSProperties, tooltip_text="Vazio"}: CardProps) {
  ...
  return (
    <div className="card flex flex-col relative bg-gray-50" style={others_style}>
      <div className="wrapper-icon absolute inset-0 overflow-hidden rounded-[20px] z-[-1]">
      ...
      <div className="relative !p-4 !px-5">
        <div className="flex justify-center gap-1">
          ...
          <Tooltip label={tooltip_text} show={{ "--tooltip-hover-x": "-500%", "--tooltip-hover-y": "175%" } as React.CSSProperties}>
      ...
      <div className="flex flex-col gap-8 !p-4 !pt-0 !px-5">
        ...
        <div className="wrapper-img absolute inset-0 overflow-hidden rounded-[20px] z-[-1]">
